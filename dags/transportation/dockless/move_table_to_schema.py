# Basic script to move specific tables from 'public'
# to another schema using a binding library.
...
cur = conn_str.cursor()
cur.execute("""create schema if not exists mds""")
...
cur.execute(
    """alter materialized view if exists public.v_status_changes set schema mds"""
)
