...
schemaName = "waze"
# S3 Config
bucket_source_name = 'your-input-bucket'
bucket_processed_name = 'your-processed-bucket'
...
def tab_jams(raw_data):
	...
	#print("test1")
	#print(df_jams["pub_millis"])
	#print("test2")
	#print(raw_data["json_hash"])
	#print("test3")
...
for key in bucket_source.objects.all(): # a list of ObjectSummary
	...
	if "/" not in key.key and key.key.endswith('.json'):
		...
		raw_data = tab_raw_data(key.key) #filepath.name) #"wazedata_2017_12_11_23_08_02_202.json")
